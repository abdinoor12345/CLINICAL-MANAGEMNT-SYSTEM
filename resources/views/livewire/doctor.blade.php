 ...
 <div class=" items-center">
  <div class="flex items-center space-x-2 text-base">
    <h4 class="font-semibold text-slate-900 bg-indigo-500">our Doctors</h4>
    <span class="rounded-full px-2 py-1 text-xs font-semibold text-slate-700 bg-red-500">25</span>
  </div>
  <div class="mt-3 flex -space-x-2 overflow-hidden">
    ...
    <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white"
     src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""/>
  </div>
  <div class="mt-3 text-sm font-medium">
    <a href="#" class="text-blue-500">+ 20 others</a>
  </div>
    
  <div class="flex items-center justify-content">
  <img  class="inline-block h-12 w-12 rounded-full ring-2 ring-white"src="images/doctor.png">
  <div>
